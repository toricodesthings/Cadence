...
export function CommandPalette({ open, onOpenChange }: CommandPaletteProps) {
    ...
    const items = useMemo<CommandItem[]>(() => {
        const nav: CommandItem[] = [
            ...
            { id: "nav-holding", name: "Holding", icon: <Inbox size={14} />, section: "navigation", action: () => navigate("/inbox") },
        ...
        const actions: CommandItem[] = [
            { id: "action-new-task", name: "New task", icon: <Plus size={14} />, section: "actions", action: () => navigate("/inbox"), shortcut: "T" },
        ];
