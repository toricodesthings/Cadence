/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fc377d7804525a520a0025cc9cd125cd)
...
declare namespace Cloudflare {
	...
	interface DevEnv {
		...
		PROD_MANAGEMENT_DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MANAGEMENT_DATABASE_URL" | "PROD_MANAGEMENT_DATABASE_URL" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE" | "NEON_AUTH_JWKS_URL" | "ENABLE_DEBUG_ROUTES" | "ADMIN_USER_IDS" | "DEPLOYMENT_STAGE">> {}
}
