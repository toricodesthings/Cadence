                ...
                <DropdownMenu.Root>
                    <DropdownMenu.Trigger asChild>
                        <button
                            ...
                            className="w-5 h-5 rounded-xl flex items-center justify-center text-twilight-text-muted hover:text-twilight-text transition-colors cursor-pointer opacity-0 group-hover:opacity-100 focus-visible:opacity-100 shrink-0"
