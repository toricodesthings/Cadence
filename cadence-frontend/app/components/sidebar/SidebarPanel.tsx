...
import { CalendarRange, Inbox, CheckCircle2, Trash2, LayoutDashboard } from "lucide-react";
...
export function SidebarPanel() {
    ...
    return (
        <div
            id="sidebar-panel"
            className="w-56 flex flex-col border-r border-twilight-border shrink-0 pb-4"
            ...
            <ScrollArea.Root className="flex-1">
                <ScrollArea.Viewport className="h-full px-3 py-5">
                    ...
                    <Collapsible.Root open={tagsOpen} onOpenChange={setTagsOpen}>
                        <div className="flex items-center justify-between px-3 mb-2">
                            <Collapsible.Trigger asChild>
                                <button className="text-[12px] font-semibold text-twilight-text-muted uppercase tracking-[0.12em] hover:text-twilight-text-soft transition-colors cursor-pointer">
                                    Tags
                                </button>
                            </Collapsible.Trigger>
                            <button
                            ...
                            >
                                <Plus size={14} className="text-twilight-text-muted hover:text-twilight-text transition-colors" />
                            </button>
                        </div>
                        <Collapsible.Content>
                            {/* Mini search */}
