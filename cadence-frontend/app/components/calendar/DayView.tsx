...
function DroppableTimeGrid({
    ...
    const handleGridClick = (e: React.MouseEvent<HTMLDivElement>) => {
        ...
        const totalMins = Math.round(((relY / HOUR_HEIGHT) * 60) / 60) * 60;
    ...
    return (
        <div
            ...
            className={`
                ...
                ${isOver ? "bg-[color-mix(in_srgb,var(--color-moonlit)_8%,transparent)]" : ""}
            `}
...
export function DayView({ currentDate, tasks, onSelectTask, onCompleteTask, onArchiveTask, onGridClick }: DayViewProps) {
