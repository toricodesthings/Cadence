                ...
                <div className="shrink-0 w-[280px]">
                    {!isAddingColumn ? (
                        <button
                            ...
                            className="flex items-center gap-2 w-full py-4 px-5 rounded-t-2xl bg-white/[0.02] border border-dashed border-twilight-border/50 text-twilight-text-muted hover:text-twilight-text hover:bg-white/[0.04] transition-colors"
                        >
                            <Plus size={16} />
