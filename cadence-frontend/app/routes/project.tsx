                ...
                <AlertDialog.Content>
                    ...
                    <AlertDialog.Footer>
                        <AlertDialog.Cancel asChild>
                            <button className="px-4 py-2 rounded-xl text-sm text-twilight-text-muted hover:text-twilight-text hover:bg-white/[0.06] transition-colors">
                                Cancel
                            </button>
                        </AlertDialog.Cancel>
                        <AlertDialog.Action asChild>
                            <button
                                ...
                                className="px-4 py-2 rounded-xl text-sm bg-red-500/20 text-red-400 hover:bg-red-500/30 transition-colors"
                            >
                                Delete project
                            </button>
                        </AlertDialog.Action>
                ...
                <ScrollAreaWrapper>
                    <div className="max-w-2xl mx-auto px-8 py-8">
                        <div className="flex items-center gap-4 mb-8">
                            <div
                                className="w-12 h-12 rounded-2xl flex items-center justify-center glow-lantern"
                                style={{ backgroundColor: project ? `${resolveAccentColor(project.colorAccent)}20` : 'rgba(255,255,255,0.1)' }}
                            >
                                {project?.emoji ? (
                                    ...
                                    <FolderKanban
                                        size={22}
                                        style={{ color: project ? resolveAccentColor(project.colorAccent) : 'var(--color-twilight-text)' }}
                                    />
                                )}
                            </div>
                            <div className="flex-1 min-w-0">
                                <h2 className="font-display text-2xl font-semibold text-twilight-text leading-tight truncate">
                                    {project ? project.name : "Loading project..."}
                                </h2>
                                <p className="text-sm text-twilight-text-muted mt-1">
                                ...
                                <DropdownMenu.Root>
                                    <DropdownMenu.Trigger asChild>
                                        <button
                                            ...
                                            className="w-8 h-8 rounded-lg flex items-center justify-center text-twilight-text-muted hover:text-twilight-text hover:bg-white/[0.06] transition-colors shrink-0"
                                        >
